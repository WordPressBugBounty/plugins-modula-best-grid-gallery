	...
	public static function get_tabs() {
		...
		return apply_filters(
			...
			array(
				...
				'exif'                 => array(
					'label'    => esc_html__( 'Photo metadata', 'modula-best-grid-gallery' ),
					'title'    => esc_html__( 'Photo metadata', 'modula-best-grid-gallery' ),
				...
				'general'              => array(
					'type'                  => array(
						...
						'values'    => array(
							...
							'parallax-masonry' => esc_html__( 'Parallax', 'modula-best-grid-gallery' ),
						),
						'disabled'  => array(
	...
	public static function get_defaults() {
		return apply_filters(
			...
			array(
				...
				'enable_responsive'        => 1,
				'polaroid_rotation_max'    => 7,
				'polaroid_scatter_max'     => 12,
				'polaroid_show_pin'        => 1,
				'polaroid_frame_padding'   => 12,
				'polaroid_chin_height'     => 36,
				'polaroid_uniform_size'    => 1,
				'polaroid_uniform_columns' => 3,
				'polaroid_random_factor'   => 50,
			)
		);
	}
}
